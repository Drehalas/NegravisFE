    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">From signup to your first API call in minutes</p>
        </div>

        <div className="grid md:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className={`bg-white rounded-xl shadow-lg border-2 p-6 transition-all cursor-pointer ${
                currentStep === index + 1 ? 'border-blue-500 scale-105' : 'border-gray-100 hover:border-blue-200'
                ...
                <button className={`w-full py-2 px-4 rounded-lg font-medium transition-colors ${
                  currentStep === index + 1 ? 'bg-blue-500 text-white hover:bg-blue-600' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}>
                  {step.action}
                </button>
              </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Negravis?</h2>
          <p className="text-lg text-gray-600">Built for developers who need reliable, fast, and secure data</p>
        </div>
